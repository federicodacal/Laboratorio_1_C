    ...
    do{
        ...
        case 10:
            ...
            switch(menuInformes()){
                ...
                case 8:
                    system("cls");
                    totalAlmuerzosSector(almuerzos, ALMUERZO_LENGTH,comidas, COMIDA_LENGTH,sectores, SECTOR_LENGTH, nomina,NOMINA_LENGTH);
                    system("pause");
                    break;
                case 9:
                    system("cls");
                    milanesasPorSector(almuerzos, ALMUERZO_LENGTH,comidas, COMIDA_LENGTH,sectores, SECTOR_LENGTH, nomina,NOMINA_LENGTH);
                    system("pause");
                    break;
                case 10:
                    system("cls");
                    sectorMasMilanesas(almuerzos, ALMUERZO_LENGTH,comidas, COMIDA_LENGTH,sectores, SECTOR_LENGTH, nomina,NOMINA_LENGTH);
                    system("pause");
                    break;
                case 11:
                    system("cls");
                    listarTotalComidasFecha(almuerzos,ALMUERZO_LENGTH,comidas,COMIDA_LENGTH);
                    system("pause");
                    break;
                case 12:
                    system("cls");
                    ingresoPorComidas(almuerzos, ALMUERZO_LENGTH,comidas, COMIDA_LENGTH);
                    system("pause");
                    break;
            }
            break;
...
int menuInformes()
{
    ...
    printf("8. Total $ Almuerzos por Sector\n");
    printf("9. Total Milanesas por Sector\n");
    printf("10. Sector Mas Milanesas\n");
    printf("11. Total Comidas por Fecha\n");
    printf("12. Recaudacion por Comida\n");
    printf("12. Volver al Menu\n");
    printf("\nIngrese opcion: \n");
    scanf("%d", &opcion);
